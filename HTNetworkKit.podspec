...
Pod::Spec.new do |s|
  s.name             = 'HTNetworkKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HTNetworkKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/JamesLiAndroid/HTNetworkKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'JamesLiAndroid' => 'lisongyang@hoteamsoft.com' }
  s.source           = { :git => 'https://github.com/JamesLiAndroid/HTNetworkKit.git', :tag => s.version.to_s }
